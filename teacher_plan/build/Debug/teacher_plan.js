...
wasmBinaryFile = "teacher_plan.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var worker;
  var pthreadMainJs = locateFile("teacher_plan.worker.js");
...
function _fd_sync(fd) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(37, 1, fd);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
...
var ___start_em_js = Module["___start_em_js"] = 8947220;

var ___stop_em_js = Module["___stop_em_js"] = 8947702;
